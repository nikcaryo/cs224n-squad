...
class BiDAF(nn.Module):
    ...
    """
    def __init__(self, word_vectors, hidden_size, drop_prob=0., char_vectors=[], num_layers=1):
...
class CharBiDAF(nn.Module):
    ...
    Args:
        ...
        drop_prob (float): Dropout probability.
    """
    def __init__(self, word_vectors, hidden_size, char_vectors, drop_prob=0. , num_layers=1):
        ...
        self.enc = layers.RNNEncoder(input_size= word_vectors.size(1) + 2 * hidden_size,
                                     hidden_size=hidden_size,
                                     num_layers=1,
                                     drop_prob=drop_prob)
